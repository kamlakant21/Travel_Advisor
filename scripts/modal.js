        ...
        $.ajax(HotelApi).done(function (response) {
            ...
            for (var i = 0; i < 3; i++) {
                ...
                if (dataNumber > 200000) {
                    ...
                    $("#hotel-card-" + (i + 1) + "-text").append("<div class='recommendation bg-warning text-light'><span class=badge badge-pill badge-warning'>Moderate Risk Area</span></div>")
                } else {
                    $("#hotel-card-" + (i + 1) + "-text").append("<div class='recommendation bg-success text-light'><span class='badge badge-pill badge-success'>Low Risk Area</span></div>")
                }
